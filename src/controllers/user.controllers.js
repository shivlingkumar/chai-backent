...
const logoutUser = asyncHandler(async (req, res) => {
  await User.findByIdAndUpdate(
    req.user._id,
    {
      ...
      $unset:{
        refreshToken:1
        //this remove the field for document
      }
    },
    {
      new: true,
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "avatar image update successyfully"));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "coverImage update successyfully"));
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        user[0].watchhistory,
        "Watch history fetchd successyfully"
      )
    );
});
